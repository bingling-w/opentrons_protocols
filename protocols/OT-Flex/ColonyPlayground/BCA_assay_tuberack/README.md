...
This code instead assumes you have your 8 standards in tuberacks (seperate from the unknowns) rather than the column of a wellplate
...
- Dispense 10 µL of BSA standards into column 1 (and column 2-3 if there's replicates)
